...
<section class="text-gray-600 body-font">
   <div class="flex flex-col mb-10 lg:items-start items-center px-24">
        <div class="flex-grow">
            ...
            {{ $adminProperty['address']['line'] }}, {{ $adminProperty['address']['city'] }}, {{ $adminProperty['address']['state'] }}, {{ $adminProperty['address']['postal_code'] }}
            </h1>
          <h2 class="text-gray-900 text-lg title-font font-medium mb-3 ml-12">Overview</h2>
          <p class="leading-relaxed text-base ml-12">{{ $adminProperty['description'] ?? '' }}</p>
        </div>
      </div>
           ...
           <div class="container mx-auto grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 pt-6 gap-8">
                    <div class="rounded border-gray-300 h-24">
                        ...
                        <div class="space-y-2">
                            ...
                            <p class="leading-snug">{{ $adminProperty['beds'] ?? 'No data available' }}</p>
                        </div>
                    </div>
                    </div>
                    <div class="rounded border-gray-300 h-24">
                        ...
                        <div class="space-y-2">
                            ...
                            <p class="leading-snug">{{ $adminProperty['baths_full'] ?? 'No data available' }}</p>
                        </div>
                    </div>
                    </div>
                    <div class="rounded border-gray-300 h-24">
                        ...
                        <div class="space-y-2">
                            ...
                            <p class="leading-snug">${{ $adminProperty['price'] ?? 'No data available' }}</p>
                        </div>
                    </div>
                    </div>
                    <div class="rounded border-gray-300 h-24">
                        ...
                        <div class="space-y-2">
                            ...
                            <p class="leading-snug">{{ $adminProperty['year_built'] ?? 'No info' }}</p>
                        </div>
                    </div>
                    </div>
                </div>
