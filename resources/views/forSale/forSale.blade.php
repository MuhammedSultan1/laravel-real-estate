...
<section class="dark:bg-coolGray-800 dark:text-coolGray-100">
    ...
    <p class="text-2xl font-bold leading-5">Properties listed by the admin</p>
                      ...
                      <div class="max-w-sm mx-auto overflow-hidden bg-white rounded shadow-lg">
                          <a href="{{ route('adminProperty', $adminProperty['slug']) }}">
                            ...
                            <div class="px-6 py-4">
                                ...
                                <p class="py-2 text-gray-700">{{ $adminProperty['beds'] ?? ''}} beds, {{ $adminProperty['baths'] ?? ''}} baths, {{ $adminProperty['sqft'] ?? ''}} Sqft</p>
                                <div class="flex items-center mt-4 text-gray-700">
                                    ...
                                    <h1 class="px-2 text-sm">{{ $adminProperty['address'] ?? ''}}</h1>
                                </div>
                            </div>
                          </a>
                        </div>
...
<section class="dark:bg-coolGray-800 dark:text-coolGray-100">
	<div class="container flex flex-col-reverse mx-auto lg:flex-row">
    <p class="text-2xl font-bold leading-5">Properties listed by the API</p>
    <div class="container mx-auto grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 pt-6 gap-8">
